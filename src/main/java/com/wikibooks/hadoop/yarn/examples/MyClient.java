 ...
 *
 * <p>
 * This client allows an application master to be launched that in turn would
 * run the provided the HelloYarn on a set of containers.
 * </p>
 *
 * <p>
 ...
 * {@link org.apache.hadoop.yarn.api.ApplicationClientProtocol}. The
 * {@link org.apache.hadoop.yarn.api.ApplicationClientProtocol} provides a way
 * for the client to get access to cluster information and to request for a new
 * {@link org.apache.hadoop.yarn.api.records.ApplicationId}.
 * <p>
 *
 * <p>
 ...
 * {@link org.apache.hadoop.yarn.api.records.ApplicationSubmissionContext}
 * defines the application details such as
 * {@link org.apache.hadoop.yarn.api.records.ApplicationId} and application
 * name, the priority assigned to the application and the queue to which this
 * application needs to be assigned. In addition to this, the
 * {@link org.apache.hadoop.yarn.api.records.ApplicationSubmissionContext} also
 * defines the {@link org.apache.hadoop.yarn.api.records.ContainerLaunchContext}
 * which describes the <code>Container</code> with which the
 * {@link com.wikibooks.hadoop.yarn.examples.MyApplicationMaster} is launched.
 * </p>
 *
 * <p>
 * The {@link org.apache.hadoop.yarn.api.records.ContainerLaunchContext} in this
 * scenario defines the resources to be allocated for the
 * {@link com.wikibooks.hadoop.yarn.examples.MyApplicationMaster}'s container,
 * the local resources (jars, configuration files) to be made available and the
 * environment to be set for the
 * {@link com.wikibooks.hadoop.yarn.examples.MyApplicationMaster} and the
 * commands to be executed to run the
 * {@link com.wikibooks.hadoop.yarn.examples.MyApplicationMaster}.
 * <p>
 *
 * <p>
 * Using the
 * {@link org.apache.hadoop.yarn.api.records.ApplicationSubmissionContext}, the
 * client submits the application to the <code>ResourceManager</code> and then
 * monitors the application by requesting the <code>ResourceManager</code> for
 * an {@link org.apache.hadoop.yarn.api.records.ApplicationReport} at regular
 * time intervals. In case of the application taking too long, the client kills
 * the application by submitting a
 * {@link org.apache.hadoop.yarn.api.protocolrecords.KillApplicationRequest} to
...
public class MyClient {
	...
	// Amt of memory to request for container in which the HelloYarn will be
	// executed
	private int containerMemory = 10;

	// Amt. of virtual cores to request for container in which the HelloYarn will be
	// executed
	...
	public boolean init(String[] args) throws ParseException {
		...
		if (this.containerMemory < 0 || this.containerVirtualCores < 0 || this.numContainers < 1) {
			throw new IllegalArgumentException("Invalid no. of containers or container memory/vcores specified,"
					+ " exiting." + " Specified containerMemory=" + this.containerMemory + ", containerVirtualCores="
					+ this.containerVirtualCores + ", numContainer=" + this.numContainers);
		}
	...
	public boolean run() throws IOException, YarnException {
		...
		// Set the ContainerLaunchContext to describe the Container ith which the
